...
namespace LibraryExceptionThreading
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            new Thread(() => { Library.LoanBook(s1, 1000); }).Start();
            new Thread(() => { Library.LoanBook(s4, 1002); }).Start();
            new Thread(() => { Library.LoanBook(s3, 876); }).Start();
            new Thread(() => { Library.LoanBook(s3, 1002); }).Start();
            new Thread(() => { Library.LoanBook(s3, 876); }).Start();
