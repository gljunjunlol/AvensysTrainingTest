...
namespace Gabriel_Bank_Management_System.Interfaces
{
    interface IBankViewModel
    {
        ...
        IList<string> validatePassword(string password);
        ...
        string DeleteManager(string bankmanager_id);
        ...
        void ParseInputDecimal(string input, out decimal? value);
        void ParseInputDate(string input, out DateTime? value);
